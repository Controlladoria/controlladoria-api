...
class Settings(BaseSettings):
    ...
    admin_email: str = "suportecontrolladoria@gmail.com"  # Receive contact form notifications
    support_email: str = "suportecontrolladoria@gmail.com"  # Support contact for CNPJ conflicts
